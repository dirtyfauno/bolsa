...
<head>
	...
	<link href="//fonts.googleapis.com/css?family=Muli:300,400,400|Josefin+Slab:100,700" rel="stylesheet" type="text/css">
...
<nav class="nav-principal clearfix">
	<div class="contenedor-nav clearfix">
		<div class="titulo-contenedor clearfix">
			<h1 class="titulo-pagina">VACANTES TRABAJO {{$vacantes_tipo}}&nbsp;({{$vacantes_totales}}) ~ {{$carrera_nombre}}</h1>
		</div>
